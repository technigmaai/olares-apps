...
|---|---|---|---|---|---|
| [deepseekharness](./deepseekharness) | DeepSeek Harness | 0.1.6 | 0.1.5-rc.2 | Developer Tools | Agentic coding environment with Caddy web login, CLI terminal (DSH + workstation toolchain) |
